        ...
        return{
            init:function(){
                ...
                _initStyles:function(){
                    this.$background.css({"background-attachment":"scroll"})
                },
                ...
                _bindEvents:function(){
                    ...
                    _updateBgPos:function(){
                        if(this._visibleInViewport()){
                            ...
                            "horizontal"===this.settings.direction?(y=j?a+"px auto":"auto "+b+"px",z=x-u*A+"px 50%"):(y=j?"auto "+b+"px":a+"px auto",z="50% "+(s*A-w)+"px"),this.$background.css({"background-size":y,"background-position":z})}this.ticking=!1}}},b.defaults=c,a.fn.parallaxScroll=function(a){return this.each(function(){new b(this,a).init()})},b});